let questions = [
    ...
    },
    {
        ...
        answer: "D. The region around a star where conditions may be suitable for life.",
        options: [
    ...
    },
    {
        ...
        answer: "B. An exoplanet with a mass larger than Earth's but smaller than that of Neptune.",
        options: [
    ...
    {
        numb: 8,
        question: "Which space telescope has been instrumental in discovering exoplanets?",
    ...
    {
        numb: 9,
        question: "What is the main component of an exoplanet's atmosphere that scientists search for to indicate potential life?",
        answer: "A. Oxygen",
        options: [
            "A. Oxygen",
            "B. Nitrogen",
    ...
    },
    {
        ...
        answer: "B. When a planet passes in front of its star, causing a temporary dimming.",
        options: [
    ...
    },
    {
        ...
        answer: "C. It contains seven Earth-sized exoplanets in the habitable zone.",
        options: [
    ...
    {
        numb: 12,
        question: "What is the main challenge in finding Earth-like exoplanets?",
    ...
    {
        numb: 13,
        question: "Which method involves measuring the wobble of a star to detect exoplanets?",
    ...
    {
        numb: 15,
        question: "Which element is often looked for in exoplanet atmospheres as a potential biosignature?",
        answer: "C. Methane",
        options: [
            "A. Argon",
            "B. Helium",
    ...
    {
        numb: 17,
        question: "What is the main advantage of the direct imaging method for detecting exoplanets?",
        answer: "B. It allows scientists to study the atmosphere of the planet.",
        options: [
    ...
    {
        numb: 18,
        question: "What is the purpose of the James Webb Space Telescope in relation to exoplanets?",
    ...
    {
        numb: 20,
        question: "What is the primary focus of the Exoplanet Exploration Program?",
