let questions = [
    {
        ...
        answer: "C. A region in space with a gravitational pull so strong that nothing can escape.",
        options: [
            "A. A type of star",
            "B. A large planet",
    ...
    {
        numb: 4,
        question: "What forms when a massive star collapses under its own gravity?",
        answer: "C. Black hole",
        options: [
            "A. Neutron star",
            "B. White dwarf",
    ...
    {
        numb: 5,
        question: "What is the point of infinite density in a black hole called?",
    ...
    {
        numb: 6,
        question: "Which type of black hole is formed from the remnants of a supernova?",
    ...
    {
        numb: 8,
        question: "What is the name of the phenomenon where light bends around a black hole?",
    ...
    {
        numb: 10,
        question: "What is the term for the disk of gas and dust that surrounds a black hole?",
    ...
    {
        numb: 12,
        question: "What evidence do scientists use to infer the presence of black holes?",
    ...
    {
        numb: 14,
        question: "What are black holes that are formed from the collapse of massive stars called?",
    ...
    },
    {
        ...
        answer: "A. From the merging of smaller black holes and gas accumulation",
        options: [
    ...
    {
        numb: 18,
        question: "What type of black hole can theoretically exist and is smaller than stellar black holes?",
    ...
    {
        numb: 19,
        question: "What instrument is primarily used to detect black holes indirectly?",
